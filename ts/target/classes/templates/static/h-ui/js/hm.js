(function () {
    var h = {}, mt = {}, c = {
        id: "080836300300be57b7f34f4b3e97d911",
        dm: ["h-ui.net"],
    ...
    (function () {
        var a = mt.lang, b = h.w, d = h.load, f = {
            Ca: function (g) {
    ...
    (function () {
        ...
        var d = mt.lang, f = mt.l, g = mt.f, n = h.w, l = h.H, p = h.ha, e = {
            s: [], C: 0, Y: u, o: {U: "", page: ""}, init: function () {
                e.e =
                    0;
                l.c("pv-b", function () {
                    e.ia();
                ...
                if (0 < e.s.length) for (var a = 0, d = e.s.length; a < d; a++) e.R(e.s[a]);
                e.s = t
            }, R: function (a) {
                var b = a[0];
            ...
            _trackEvent: function (a) {
                ...
                if (d.d(a, "Object")) {
                    ...
                    if (900 >= m) g.call(this, a); else for (var m = Math.ceil(m / 900), s = "block|" + Math.round(Math.random() * n.Q).toString(16) + "|" + m + "|", l = [], v = 0; v < m; v++) l.push(v), l.push(a.substring(900 * v, 900 * v + 900)), g.call(this, s + l.join("|")), l = []
                }
    ...
    (function () {
        function a() {
            "undefined" === typeof window["_bdhm_loaded_" + c.id] && (window["_bdhm_loaded_" + c.id] = r, this.a = {}, this.X = r, this.N = u, this.init())
        }

        var b = mt.url, d = mt.aa, f = mt.T, g = mt.lang, n = mt.cookie, l = mt.f, p = mt.localStorage,
            e = mt.sessionStorage, k = h.w, w = h.H;
        a.prototype = {
            O: function (a, b) {
                a = "." + a.replace(/:\d+/, "");
                b = "." + b.replace(/:\d+/, "");
                ...
                for (var a = document.location.hostname, b = 0, d = c.dm.length; b < d; b++) if (this.O(a, c.dm[b])) return c.dm[b].replace(/(:\d+)?[\/\?#].*/, "");
                return a
            }, V: function () {
                ...
                var a =
                    u;
                this.A(document.referrer) && this.A(document.location.href) ? a = r : (a = b.W(document.referrer), a = this.O(a || "", document.location.hostname));
                ...
                try {
                    n.set(a, b, {domain: this.J(), path: this.V(), I: d}), d ? p.set(a, b, d) : e.set(a, b)
                } catch (f) {
                }
            }, Ha: function (a) {
                try {
                    n.set(a, "", {domain: this.J(), path: this.V(), I: -1}), e.remove(a), p.remove(a)
                } catch (b) {
                }
            }, Ma: function () {
                var a, b, d, e, f;
                ...
                try {
                    this.Na(), 0 === this.a.nv ? this.Ka() : this.S(".*"), h.b = this, this.ga(), w.z("pv-b"), this.Ja()
                } catch (a) {
                    var b = [];
                    b.push("si=" + c.id);
                ...
                this.X ? (this.N = r, this.a.et = 0, this.a.ep = "", this.a.vl = l.L() + l.M(), this.j(a)) : a()
            }, j: function (a) {
                var b = this;
                ...
                a && (d.test(a) && e && g) && (this.a.rnd = Math.round(Math.random() * k.Q), a = document.createElement("script"), a.setAttribute("type", "text/javascript"), a.setAttribute("charset", "utf-8"), a.setAttribute("src", k.protocol + "//" + c.js + f + ".js?" + this.a.rnd), f = document.getElementsByTagName("script")[0], f.parentNode.insertBefore(a, f))
            }, da: function (a) {
    ...
    (function () {
        var a = mt.event, b = mt.lang, d = h.w;
